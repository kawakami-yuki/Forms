...
// @LINE:7
private[this] lazy val controllers_Application_send1 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("send"))))
...
def documentation = List(("""GET""", prefix,"""controllers.Application.index()"""),("""POST""", prefix + (if(prefix.endsWith("/")) "" else "/") + """send""","""controllers.Application.send()"""),("""GET""", prefix + (if(prefix.endsWith("/")) "" else "/") + """assets/$file<.+>""","""controllers.Assets.at(path:String = "/public", file:String)""")).foldLeft(List.empty[(String,String,String)]) { (s,e) => e.asInstanceOf[Any] match {
...
case controllers_Application_send1(params) => {
   call { 
        invokeHandler(controllers.Application.send(), HandlerDef(this, "controllers.Application", "send", Nil,"POST", """""", Routes.prefix + """send"""))
   }
}
